  ...
  return (
    <div className="w-screen h-full flex-col bg-gray-50 py-10">
      <div className=" flex-col lg:w-2/3 sm:w-auto text-base">
        <h2 className="font-bold text-2xl m-5 ">Create a public post</h2>

        <div className="p-5 bg-blue-100 rounded-md m-5">
          <h2 className="text-lg font-semibold">Writing a good post</h2>
          <p>
            You’re ready to write a programming-related article and this form
        ...
        <form onSubmit={handlePost}>
          ...
          <div className="m-5 p-5 bg-blue-100 rounded-md">
            ...
            <p>
              Introduce your thoughts and expand on what you put in the title
            </p>
            <textarea
              name="content"
              onChange={handleChange}
              ...
              cols="30"
              rows="10"
              className="w-full p-3 my-3 rounded-md border border-black"
            ></textarea>
          </div>

          <button
            type="submit"
            className="mx-5 my-1 px-4 py-2 bg-blue-400 rounded-md"
          >
            Publish
          </button>
        </form>
